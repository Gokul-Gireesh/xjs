...
**Output (approx):**
```css
body {background: #fafafa;color: #111;h1 {font-size: 24px;color: royalblue;}}
```
...
**HTML**
- `html(templateFn | templateLiteral)` — create a template/component. Returns a callable object that renders to string.  
